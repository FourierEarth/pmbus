...
pmbus_macros::impl_commands! {
    ...
    | 0x83 | READ_KWH_IN               | _             | read: u32       | 4  |,
    | 0x84 | READ_KWH_OUT              | _             | read: u32       | 4  |,
    | 0x85 | READ_KWH_CONFIG           | write: u16    | read: u16       | 2  |,
    | 0x86 | READ_EIN                  | _             | read: &[u8; 5]  | 5  |,
    | 0x87 | READ_EOUT                 | _             | read: &[u8; 5]  | 5  |,
    ...
    | 0x99 | MFR_ID                    | write: &[u8]  | read: &[u8]     | _  |,
    | 0x9A | MFR_MODEL                 | write: &[u8]  | read: &[u8]     | _  |,
    | 0x9B | MFR_REVISION              | write: &[u8]  | read: &[u8]     | _  |,
    | 0x9C | MFR_LOCATION              | write: &[u8]  | read: &[u8]     | _  |,
    | 0x9D | MFR_DATE                  | write: &[u8]  | read: &[u8]     | _  |,
    | 0x9E | MFR_SERIAL                | write: &[u8]  | read: &[u8]     | _  |,
    | 0x9F | APP_PROFILE_SUPPORT       | _             | read: &[u8]     | _  |,
    ...
    | 0xAA | MFR_EFFICIENCY_LL         | _             | read: &[u8; 14] | 14 |,
    | 0xAB | MFR_EFFICIENCY_HL         | _             | read: &[u8; 14] | 14 |,
    | 0xAC | MFR_PIN_ACCURACY          | _             | read: u8        | 1  |,
    | 0xAD | IC_DEVICE_ID              | _             | read: &[u8]     | _  |,
    | 0xAE | IC_DEVICE_REV             | _             | read: &[u8]     | _  |,
    | 0xAF | _                         | _             | _               | _  |,
    | 0xB0 | USER_DATA_00              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB1 | USER_DATA_01              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB2 | USER_DATA_02              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB3 | USER_DATA_03              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB4 | USER_DATA_04              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB5 | USER_DATA_05              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB6 | USER_DATA_06              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB7 | USER_DATA_07              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB8 | USER_DATA_08              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xB9 | USER_DATA_09              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xBA | USER_DATA_10              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xBB | USER_DATA_11              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xBC | USER_DATA_12              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xBD | USER_DATA_13              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xBE | USER_DATA_14              | write: &[u8]  | read: &[u8]     | _  |,
    | 0xBF | USER_DATA_15              | write: &[u8]  | read: &[u8]     | _  |,
